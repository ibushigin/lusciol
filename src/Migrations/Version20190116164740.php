 ...
 */
final class Version20190116164740 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP adress_id, CHANGE address_id address_id INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD adress_id INT NOT NULL, CHANGE address_id address_id INT DEFAULT NULL');
